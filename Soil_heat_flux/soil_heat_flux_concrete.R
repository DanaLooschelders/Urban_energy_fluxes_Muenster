...
delta_T<-FO_concrete_surface_30min$X0.temp - FO_concrete_surface_30min$X0.01.temp #Temperatur gradient 
plot(delta_T, type="l")
delta_z<-0.01 #difference in depth [m]
k=0.30955 #bootstrapped
