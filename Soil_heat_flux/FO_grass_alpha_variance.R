...
alpha(u=FO_grass_df_t$`2021-07-29 14:29:12`, 
      nextu=FO_grass_df_t$`2021-07-29 14:29:36`,
...
ggplot(alphas_grass, aes(x=time, y=alpha))+
  ...
  theme_bw()
#calculate mean
mean(alpha_values_grass, na.rm=T)
...
unrealistic_alphas<-alphas_grass[alphas_grass<0|alphas_grass>1*10^-7]
####for an hour####
...
mean(alphas_grass$alpha[alphas_grass$alpha>=0], na.rm=T) #1.543402e-07
mean(alphas_grass$alpha, na.rm=T) #9.243853e-09
