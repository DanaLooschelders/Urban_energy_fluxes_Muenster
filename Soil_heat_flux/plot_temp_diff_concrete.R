...
colnames(df_concrete_diff_t)<-colnames(FO_concrete_df)[1:104]
#add time
df_concrete_diff_t$time<-FO_concrete_temp_time_df_short$time
...
concrete_day_means<-data.frame("mean"=colMeans(concrete_day[,1:104]), 
                      "height"=as.numeric(colnames(concrete_day)[1:104]))
...
concrete_night_means<-data.frame("mean"=colMeans(concrete_night[,1:104]), 
                        "height"=as.numeric(colnames(concrete_night)[1:104]))
